  ...
  return (
    <footer className="bg-main text-white py-12 px-6 md:px-20">
      <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-10">
        {/* Brand Section */}
        <div>
          <h2 className="text-3xl font-bold tracking-wide">Root To Radiance</h2>
        ...
        <div>
          ...
          <ul className="space-y-2 text-primary/90">
            ...
            <li><Link href="/" className="hover:text-white transition">Collection</Link></li>
        ...
        <div>
          ...
          <div className="flex gap-5 text-2xl">
            {/* <a href="https://www.instagram.com/iqzaibessence/?__pwa=1" className="hover:text-white transition"></a> */}
            <FiInstagram />
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-primary/30 mt-10 pt-6 text-center text-primary/80 text-sm">
        © {new Date().getFullYear()} Root To Radiance. All rights reserved.
      </div>
    </footer>
  );
};
